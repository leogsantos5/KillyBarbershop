      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Image 3 */}
            <div className="relative group overflow-hidden rounded-lg shadow-xl">
              <img src="/images/KillyBackBrand.jpg" alt="Barber Shop Entrance" className="w-full h-[400px] object-cover transform group-hover:scale-110 transition-transform duration-500"/>
              <div className="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
          ...
          <div className="mt-16 text-center">
            <p className="text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Experimente a combinação perfeita entre barbearia tradicional e estilo moderno na Killy Ross & Xandy Gavira. 
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            {features.map((feature, index) => (
              <div key={feature.name} className="text-center group hover:scale-105 transition-transform duration-300">
                <div className={`flex items-center justify-center h-16 w-16 rounded-full mx-auto transition-colors
                  ${index % 3 === 0 ? 'bg-red-600 group-hover:bg-red-700' : 
                    index % 3 === 1 ? 'bg-blue-600 group-hover:bg-blue-700' : 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-600">
              Av. da Quinta Grande Nº 14, Alfragide
            </p>
            <div className="mt-6 space-y-2">
              <p className="text-xl text-gray-700">
                <span className="font-bold text-red-700">Horário de Funcionamento:</span><br />
                Segunda - Sábado: 9:00 - 19:00<br />
                Domingo: Fechado
              </p>
            </div>
          </div>
